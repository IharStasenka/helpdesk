...
public class TemplateSevenSpecification implements Specification<User> {

    private final UserPredicates userPredicates = new UserPredicates();

    private final Long ticketId;

    public TemplateSevenSpecification(Long ticketId) {
    ...
    public Predicate toPredicate(@NonNull Root<User> root, @NonNull CriteriaQuery<?> query, @NonNull CriteriaBuilder criteriaBuilder) {
        return userPredicates.getAssignee(root, query, criteriaBuilder, ticketId);
    }
}
